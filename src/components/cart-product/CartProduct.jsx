    ...
    return (
        <>
            <div className="mt-10 p-20">
                <h1 className="text-3xl font-bold text-blue-700 font-sans mb-9">
                    {' '}
                ...
                {selector.length > 0 ? (
                    selector.map((item, index) => (
                        ...
                        <div key={item.id} className="card card-side bg-base-100 shadow-xl mt-5">
                            <figure>
                                <img src={item.image} className="w-32 p-4" alt="product-image" />
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions justify-end">
                                    <button onClick={() => dltCartItem(index)} className="btn btn-primary">
                                        Delete
                                    </button>
                                </div>
                            </div>
